...
class RvizPredefinidoNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameters('', [
            ...
            ('goal_pose_x_gazebo', 1.87),   # Coordenada X en Gazebo
            ('goal_pose_y_gazebo', 0.81),   # Coordenada Y en Gazebo
            ('goal_pose_z_gazebo', 0.00782),
            ('goal_pose_roll_gazebo', 0.0),
            ('goal_pose_pitch_gazebo', 0.006),
            ('goal_pose_yaw_gazebo', 0.000122),
    ...
    def publish_initial_pose(self) -> None:
        """Publica la pose inicial en (0,0) del mapa inmediatamente."""
    ...
    def _feedback_callback(self, feedback_msg) -> None:
        ...
        try:
            ...
            if hasattr(feedback, 'current_pose'):
                ...
                pos_x_gazebo = pos_x_mapa - 2.0
                pos_y_gazebo = pos_y_mapa - 0.5
